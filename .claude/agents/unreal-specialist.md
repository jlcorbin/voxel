...
This project targets **Unreal Engine 5.7** — beyond the LLM training cutoff. Before suggesting APIs:
1. Read `docs/engine-reference/unreal/VERSION.md` for the pinned version and post-cutoff timeline.
2. Check `docs/engine-reference/unreal/deprecated-apis.md` before using any API.
3. Check `docs/engine-reference/unreal/breaking-changes.md` for relevant version transitions.
4. When uncertain about a 5.4–5.7 API, verify with WebSearch rather than guessing.
